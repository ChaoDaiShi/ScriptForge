...
type WorkbenchTab = "editor" | "import" | "distribute";
...
`;
  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
      ...
      {/* Tab Navigation */}
      <div className="flex items-center gap-1 border-b border-(--line-soft) px-6 py-0">
        <button
          type="button"
          ...
          className={`inline-flex items-center gap-1.5 border-b-2 px-3 py-3 text-xs font-medium transition-colors ${
            activeTab === "import"
              ...
              : "border-transparent text-(--text-subtle) hover:text-foreground"
          }`}
        >
